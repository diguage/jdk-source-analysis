...
image::assets/images/redis/redis-ziplist-structure.jpg[]
...
image::assets/images/redis/redis-ziplist-sample.png[]
...
image::assets/images/redis/redis-quicklist-structure.png[]
...
. https://www.diguage.com/post/redis-core-data-structure-1/[Redis 核心数据结构（一） - "地瓜哥"博客网^] -- 本文中的 Redis 内容是这篇文章的一个拷贝。请以原文为准备，本文尽量同步更新。
...
== 类的继承关系
image::assets/images/DiagramForLinkedList.png[]
...
image::assets/images/linkedlist-insert-node.png[]
...
image::assets/images/linkedlist-remove-node.png[]
