...
image::assets/images/wx-jikerizhi.png[{image_attr}]
...
image::assets/images/java.util.Collection.png[]
...
image::assets/images/java.util.Map.png[]

来张总体结构图：

image::assets/images/jdk-collection-classes.png[]
